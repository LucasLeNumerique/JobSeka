            ...
            {jobs.length === 0 ? (
                ...
                jobs.map(job => (
                    ...
                    >
                        ...
                        >
                            <div className="px-3 h-8 flex justify-center items-center gap-x-1 text-white bg-blue-500 hover:bg-cyan-400 rounded-full shadow-md shadow-blue-900 hover:shadow-cyan-600">
