            ...
            {jobs.length === 0 ? (
                ...
                jobs.map(job => (
                    <article 
                        ...
                        className="relative cursor-pointer p-2 lg:p-4 flex flex-col gap-2 border border-gray-600 hover:border-cyan-400 shadow-xl hover:shadow-cyan-400/50 rounded-xl"
                    >
                        <Link 
                            to={`/jobs/${job.id}`}
                            className="hidden sm:block absolute pt-3 lg:pt-5 top-0 right-3 lg:right-5"
                        >
                            <div className="px-3 h-8 flex justify-center items-center gap-x-1 text-white bg-cyan-600 hover:bg-cyan-400 rounded-full shadow-md shadow-cyan-900/100 hover:shadow-cyan-400/100">
