...
const LoginView = () => {
    ...
    return (
        <div className="mx-auto py-20 w-full max-w-[750px] flex flex-col items-center gap-y-15 text-center bg-white shadow-xl shadow-blue-400/50 rounded-xl">
            <h1>{role === "recruteur" ? "Je souhaite trouver des talents" : "Je veux trouver mon nouvel emploi"}</h1>
            <form className="w-full max-w-[350px] flex flex-col gap-y-5">
                ...
                <button className="cursor-pointer py-3 font-bold text-white bg-blue-400 hover:bg-blue-700 rounded-xl" type="submit">Se connecter</button>
            </form>
        </div>
    )
}
